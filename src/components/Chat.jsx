...
const Chat = () => {
  ...
  return (
    <div className="nav-item absolute right-5 md:right-52 top-16 bg-white hover:drop-shadow-xl dark:bg-[#42464D] p-8 rounded-lg w-96 hover:bg-light-gray dark:hover:bg-custom-dark">
      <div className="flex justify-between item-center">
        <div className="flex gap-3">
          <p className="font-semibold text-lg dark:text-gray-200">Messages</p>
          <button
            type="button"
            className={`text-white text-xs rounded p-1 px-2 bg-[${currentColor}]`}
          >
            5 New
          </button>
        </div>
